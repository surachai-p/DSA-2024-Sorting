...
def compare_sort():
    sizes = [1000, 5000, 10000]  # ขนาดข้อมูล
    bubble_times = []
    insertion_times = []
    selection_times = []
    shell_times = []
    ...
    plt.plot(sizes, quick_times, marker='x', label='Quick Sort', linestyle=':')
    plt.plot(sizes, merge_times, marker='v', label='Merge Sort', linestyle='--')
