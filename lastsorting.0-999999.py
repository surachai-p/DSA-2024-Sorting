...
def compare_sort():
    ...
    for size in sizes:
        data = [random.randint(0, 999999) for _ in range(size)]  # เปลี่ยนข้อมูลให้อยู่ในช่วง 0-999
    ...
    plt.title('Performance Comparison of Sorting Algorithms (Data 0-999999). Created By [Phum Akrthum]')
