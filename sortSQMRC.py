...
def compare_shell_quick_merge_radix_counting_sort():
    """Compares the performance of Shell Sort, Quick Sort, Merge Sort, Radix Sort, and Counting Sort."""
    ...
    plt.title('Performance Comparison: Shell Sort vs. Quick Sort vs. Merge Sort vs. Radix Sort vs. Counting Sort (Data 0-999). Created By [Thanakrit Pimarun]')
    plt.xlabel('Input Size')
    plt.ylabel('Time (Milliseconds)')
    plt.legend()
    plt.grid(True)
    plt.savefig('Shell-Quick-Merge-Radix-Counting-performance.png')
    plt.show()


# Run the comparison
compare_shell_quick_merge_radix_counting_sort()
