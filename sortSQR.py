...
def compare_shell_quick_radix_sort():
    """Compares the performance of Shell Sort, Quick Sort, and Radix Sort."""
    ...
    plt.title('Performance Comparison: Shell Sort vs. Quick Sort vs. Radix Sort (Data 0-999). Created By [Thanakrit Pimarun]')
    plt.xlabel('Input Size')
    plt.ylabel('Time (Milliseconds)')
    plt.legend()
    plt.grid(True)
    plt.savefig('Shell-Quick-Radix-performance.png')
    plt.show()

# Run the comparison
compare_shell_quick_radix_sort()
