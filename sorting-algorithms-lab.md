...
print("\n ผลลัพธ์ที่เรียงแล้ว:", sorted_data)
```
บันทึกรูปผลแบบทดสอบ
...
### บันทึกผลแบบทดสอบ
```html
เพิ่มชุดทดสอบข้อมูลที่มีค่าซ้ำกัน
ปรับปรุงโค้ดให้รองรับการเรียงลำดับจากมากไปน้อย
แสดงผลลัพธ์เพื่อวิเคราะห์ว่าโค้ดรองรับค่าซ้ำได้อย่างถูกต้อง
```
บันทึกรูปผลแบบทดสอบ
...
บันทึกโค้ดและรูปผลแบบทดสอบ
```python
def quick_sort_with_steps(arr, depth=0, pivot_type="last"):
    indent = "  " * depth
    print(f"{indent}quick_sort({arr})")
...
test_data = [64, 34, 25, 12, 22, 11, 45, 24, 6, 90]
print("\n Pivot จากตัวแรก")
quick_sort_with_steps(test_data.copy(), pivot_type="first")

print("\n Pivot จากตัวกลาง")
quick_sort_with_steps(test_data.copy(), pivot_type="middle")

print("\n Pivot จากตัวสุดท้าย")
quick_sort_with_steps(test_data.copy(), pivot_type="last")
```
...
เปรียบเทียบประสิทธิภาพ
 แบบ shell Sort กับ แบบ Insertion Sort
 สรุป
 แบบ shell Sort ใช้เวลาน้อยกว่า แบบ Insertion Sort
```
บันทึกรูปผลแบบทดสอบ
...
### บันทึกผลแบบทดสอบ
```html
 Merge Sort มีค่าเฉลี่ย O(n log n) แม้ข้อมูลจะเกือบเรียงลำดับแล้ว
 เมื่อเทียบกับ Insertion Sort ซึ่งมีค่าเฉลี่ย O(n²) แต่ ทำงานได้เร็วขึ้น ในกรณีข้อมูลเกือบเรียงลำดับ (O(n))
 หากชุดข้อมูลมีการสลับเพียงเล็กน้อย Insertion Sort อาจเร็วกว่าหรือใกล้เคียง
```
บันทึกรูปผลแบบทดสอบ
...
```html
    จากการทดลองเปรียบเทียบอัลกอริธึมการเรียงลำดับหลายประเภท พบว่าประสิทธิภาพของแต่ละอัลกอริธึมแตกต่างกันอย่างชัดเจนเมื่อใด้กับ ข้อมูลขนาดเล็ก, ขนาดใหญ่ และข้อมูลที่มีความแตกต่างของค่าต่ำและสูง

    หากข้อมูลมีขนาดเล็ก อัลกอริธึมง่ายๆ อย่าง Insertion Sort อาจเพียงพอ แต่หากต้องการความเร็ว Quick Sort และ Merge Sort จะดีกว่า

    สำหรับข้อมูลขนาดใหญ่ Quick Sort, Merge Sort เป็นตัวเลือกที่ดี Radix Sort และ Counting Sort เหมาะกับข้อมูลที่ค่าจำกัด

    ถ้าข้อมูลมีค่าต่างกันน้อย Counting Sort และ Radix Sort เหมาะสมที่สุด

    ถ้าข้อมูลมีค่าต่างกันมาก Quick Sort, Merge Sort ดีกว่า Counting Sort ไม่เหมาะสม
``` 
