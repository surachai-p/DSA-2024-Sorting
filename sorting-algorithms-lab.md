...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่1.1.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่1.2.png)
...
บันทึกโค้ด แบบทดสอบ
```
![alt text](PIC/โค้ดแบบทดสอบที่1.1.png)
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/แบบทดสอบที่1.1.png)
...
```html
 อธิบายผลที่นี่
```
![alt text](PIC/โค้ดแบบทดสอบที่1.2.png)
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/แบบทดสอบที่1.2.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่2.1.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่2.2.png)
...
บันทึกโค้ด แบบทดสอบ
```
![alt text](PIC/โค้ดแบบทดสอบที่2.1.png)
![alt text](PIC/แบบทดสอบที่2.1.png)
...
```
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/โค้ดแบบทดสอบที่2.2.png)
![alt text](PIC/แบบทดสอบที่2.2.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่3.1.png)
...
```
![alt text](PIC/การทดลองที่3.2.png)
...
บันทึกโค้ด แบบทดสอบ
```
![alt text](PIC/โค้ดแบบทดสอบที่3.1.png)
...
```
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/โค้ดแบบทดสอบที่3.2.png)
![alt text](PIC/แบบทดสอบที่3.2.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่4.1.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่4.2.png)
...
บันทึกโค้ด แบบทดสอบ
```
![alt text](PIC/โค้ดแบบทดสอบที่4.1.png)
![alt text](PIC/แบบทดสอบที่4.1.png)
...
```html
 อธิบายผลที่นี่
```
![alt text](PIC/โค้ดแบบทดสอบที่4.2.png)
![alt text](PIC/แบบทดสอบที่4.2.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่5.1.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่5.2.png)
...
```
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/โค้ดแบบทดสอบที่5.1.png)
![alt text](PIC/แบบทดสอบที่5.1.png)
...
```
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/โค้ดแบบทดสอบที่5.2.png)
![alt text](PIC/แบบทดสอบที่5.2.png)
...
### บันทึกผลการทดลอง
บันทึกรูปผลการทดลอง
![alt text](PIC/การทดลองที่6.1.png)
...
```
![alt text](PIC/การทดลองที่6.2.png)
...
```
บันทึกรูปผลแบบทดสอบ
![alt text](PIC/โค้ดแบบทดสอบที่6.png)
[text](แบบทดสอบ/แบบทดสอบที่6.ipynb)
...
ผลการเปรียบเทียบ Bubble sort, Insertion sort, Selection sort
![alt text](<PIC/Bubble,Insertion,Selection (0-99999).png>)
...
![alt text](<PIC/shell,quick,merge,radix,couting (0-99999).png>)
...
![alt text](<PIC/shell,quick,merge,radix,couting(กรณี Data 0-999).png>)

ผลการเปรียบเทียบ shell sort, quick sort, merge sort,radix sort, couting sort (กรณี Data 0-99999)
![alt text](<PIC/shell,quick,merge,radix,couting(กรณี Data 0-99999).png>)

ผลการเปรียบเทียบ shell sort, quick sort, merge sort,radix sort, couting sort (กรณี Data 0-999999)
![alt text](<PIC/shell,quick,merge,radix,couting(กรณี Data 0-999999).png>)
...
เหมาะสมกับข้อมูลขนาดเล็กเพราะใช้เวลาในการทำงานน้อย แม้จะไม่มีประสิทธิภาพสูงในกรณีข้อมูลที่มีขนาดใหญ่ แต่ในข้อมูลขนาดเล็ก มักจะเร็วกว่าการใช้อัลกอริธึมที่ซับซ้อนกว่า
หากข้อมูลมีความแตกต่างน้อย (เกือบจะเรียงลำดับแล้ว) จะทำงานได้ดี
Merge Sort / Quick Sort :
แม้ว่าจะมีค่า overhead สำหรับการจัดการ memory และการแบ่งข้อมูล แต่ในข้อมูลขนาดเล็ก มักยังสามารถให้ประสิทธิภาพดี และเร็วกว่าอัลกอริธึมที่ง่ายกว่าในบางกรณี
2. ข้อมูลขนาดใหญ่
Quick Sort :
โดยทั่วไปจะทำงานได้ดีและเร็วกว่าอัลกอริธึมอื่น ๆ สำหรับข้อมูลขนาดใหญ่ เนื่องจากมีค่าเวลาทำงานเฉลี่ย O(n log n)
อย่างไรก็ตาม ในกรณีที่ข้อมูลมีความเรียงลำดับในลักษณะเฉพาะ (เช่น มีการจัดเรียงอยู่แล้วบางส่วน) Quick Sort อาจมีประสิทธิภาพลดลง
Merge Sort :
เมื่อข้อมูลมีขนาดใหญ่และต้องการความเสถียรในการเรียงลำดับ (Stable Sort) Merge Sort เป็นตัวเลือกที่ดี โดยเฉพาะในกรณีที่ข้อมูลมีลักษณะการกระจายตัวที่หลากหลาย
3. ข้อมูลที่มีความแตกต่างน้อย (ข้อมูลที่เกือบจะเรียงลำดับแล้ว)
Insertion Sort :
เป็นตัวเลือกที่ดีที่สุดในกรณีนี้ เนื่องจากมีประสิทธิภาพที่ดีเมื่อข้อมูลเกือบจะเรียงลำดับอยู่แล้ว โดยมีเวลาทำงาน O(n)
Bubble Sort :
แม้จะมีค่าเวลา O(n²) แต่ในกรณีนี้ก็อาจมีการปรับตัวให้เร็วขึ้นได้หากข้อมูลเกือบจะเรียงแล้ว
4. ข้อมูลที่มีความแตกต่างมาก (ข้อมูลที่มีการกระจายตัวมาก)
Quick Sort :
ทำงานได้ดีในกรณีที่มีการกระจายข้อมูลหลากหลาย เนื่องจากสามารถทำงานในค่าเวลาที่เร็วกว่า O(n log n) โดยเฉพาะเมื่อเลือก pivot อย่างเหมาะสม
Merge Sort :
ถึงแม้ว่า Merge Sort จะค่อนข้างเสถียร แต่จะใช้เวลาและหน่วยความจำมากขึ้นเมื่อเทียบกับ Quick Sort
ในกรณีที่ข้อมูลกระจายตัวมาก ๆ Merge Sort อาจจะทำงานได้ดีกว่า Bubble Sort หรือ Insertion Sort ที่อาจจะช้ากว่า
