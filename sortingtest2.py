...
from sortingtest2 import selection_sort, shell_sort, quick_sort  # เพิ่มการ import ฟังก์ชัน
...
def compare_sort():
    ...
    plt.title('Performance comparison of sorting (Data 0-99999). Created By [Sronsawan]')
